...
public class Booking extends javax.swing.JFrame {
    ...
    public Booking() {
        ...
        try {
            ...
            while (sf.hasNext()) {
                Object[] row = {sf.nextInt(), sf.next(), sf.nextInt(), sf.next(), sf.next(), sf.next(), readStatus(sf.nextInt())};
    ...
    public String readStatus(int d){
        if (d == 0){ return "Empty";} else return "Busy";
    }
